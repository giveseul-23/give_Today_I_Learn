	...
	public static void main(String[] args) {
		...
		*/
		...
		try {
			...
			sql.append("UPDATE STUDENT "); //update, delete 부분은 다 동일한데 이 부분만 다르다
			sql.append("SET NAME = '홍길동99', KOR = 90, ENG = 80, MATH = 77"); //지금은 아예 통으로 넣었지만 나중에는 이 안에 변수들을 집어넣는다
			sql.append("WHERE ID = '2020111'"); //없는 ID를 넣고 UPDATE한다면 처리건수는 : 0 이 됨. 즉, 조건이 맞지 않는 경우에는 처리건수는 O

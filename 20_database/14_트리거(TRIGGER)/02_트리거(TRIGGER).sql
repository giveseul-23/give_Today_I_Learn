...
CREATE [OR REPLACE] TRIGGER 트리거명
  BEFORE [OR AFTER] -- 둘 중 하나만 사용도 되고, 둘 다 사용도 가능하다.
...
-- 트리거 작성
-- BOOK 테이블에 데이터가 입력되면(INSERT) BOOK_LOG 테이블에 이력 남기기 
...
BEGIN
    ...
    INSERT INTO BOOK_LOG
            ...
            (BOOKID, BOOKNAME, PUBLISHER, PRICE, JOB_GUBUN) -- LOGDATE 는 DEFAULT 값을 줬기때문에 적지 않는다
...
INSERT INTO book VALUES(30, '데이터베이스의 이해3', 'ITBOOK', 27000);

INSERT INTO book VALUES(32, '데이터베이스의 이해2', 'ITBOOK', 32000);
...
-------------------------------
-- INSERT, UPDATE, DELETE 작업발생시 동작하는 트리거

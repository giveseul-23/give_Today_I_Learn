<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
    		...
    		String req_name = (String)request.getAttribute("req_name"); //속성 설정이 안되어 있으면 null임
...
<head>
<meta charset="UTF-8">
<title>세션(session) 범위[ex01_session.jsp]</title>
<script>
	function sessionSet(){

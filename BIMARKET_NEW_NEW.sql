...
--id컬러명 수정 및 어드민 아이디 컬럼 추가
ALTER TABLE BOARD 
ADD (ADMIN_ID VARCHAR2(20) );

ALTER TABLE BOARD RENAME COLUMN ID TO WRITER_ID;

ALTER TABLE BOARD  
MODIFY (ADMIN_ID DEFAULT 'admin' );

COMMENT ON COLUMN BOARD.ADMIN_ID IS '댓글아이디';

--임의 추가(무시xxx)
INSERT INTO BOARD(B_NO, WRITER_ID, B_CATEGORY, B_TITLE, B_CONTENTS
, B_PASSWORD, B_STATUS, B_REGDATE,  ANSWER_DATE)
VALUES(B_SEQUENCE.NEXTVAL, 'giveseul', 'BC02', 'TEST', 'TEST', 
'TEST', 'PS01', SYSDATE , SYSDATE);
...
VALUES(P_SEQUENCE.NEXTVAL, 'giveseul', '2_1.PNG', '10000', '코트', 
'검색창에서 애슐리상점 오즈세컨 봄점퍼 코트 55  n1126  애슐리상점 톡답변이 늦어지면 문자부탁드립니다♡♡', 
'PS01', 'PC01', 'L02', '1_2.PNG');
